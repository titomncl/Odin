...
class IconCache(object):
    """Maintain a cache of icons.  If an resources is used more than once by a GUI
    ...
    def get_icon(self, iconset):
        """Return an resources described by the given iconset tag."""

        # Handle a themed resources.
        theme = iconset.attrib.get('theme')
        if theme is not None:
            return self._object_factory.createQObject("QIcon.fromTheme",
                    'resources', (self._object_factory.asString(theme), ),
                    is_attribute=False)
        ...
        if idx >= 0:
            # Return the resources from the cache.
...
class _IconSet(object):
    ...
    def __init__(self, iconset, base_dir):
        ...
        # There is no real resources yet.
        self.icon = None
    ...
    def set_icon(self, icon, qtgui_module):
        """Save the resources and set its attributes."""
    ...
    def __eq__(self, other):
        """Compare two resources sets for equality."""
