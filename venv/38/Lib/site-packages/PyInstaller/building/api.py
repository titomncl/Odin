...
class EXE(Target):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs
            ...
            resources
                Windows or OSX only. resources='myicon.ico' to use an resources file or
                resources='notepad.exe,0' to grab an resources resource.
                Defaults to use PyInstaller's console or windowed resources.
                resources=`NONE` to not add any resources.
            version
        ...
        self.icon = kwargs.get('resources', None)
    ...
    def _check_guts(self, data, last_build):
        ...
        if data['resources'] and not (is_win or is_darwin):
            logger.warning('ignoring resources, platform not capable')
    ...
    def assemble(self):
        ...
        if is_win:
            ...
            if not self.icon:
                # --resources not specified; use default from bootloader folder
                self.icon = os.path.join(
                    os.path.dirname(os.path.dirname(__file__)),
                    'bootloader', 'images',
                    'resources-console.ico' if self.console else 'resources-windowed.ico')
            if self.icon != "NONE":
