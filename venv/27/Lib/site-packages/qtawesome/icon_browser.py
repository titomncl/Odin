...
# TODO: Set resources colour and copy code with color kwarg
...
class IconBrowser(QtWidgets.QMainWindow):
    ...
    code for the currently selected resources.
    """
    ...
    def _copyIconText(self):
        """
        Copy the name of the currently selected resources to the clipboard.
        """
...
class IconModel(QtCore.QStringListModel):
    ...
    def data(self, index, role):
        """
        Re-implemented to return the resources for the current index.
