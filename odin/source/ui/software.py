...
class Software(Qw.QWidget):
    ...
    def modeling_set_widget(self):
        ...
        maya_ico = Qg.QIcon("./resources/icons/maya.ico")
        zbrush_ico = Qg.QIcon("./resources/icons/zbrush.ico")
        houdini_ico = Qg.QIcon("./resources/icons/houdini.ico")
    ...
    def texturing_widget(self):
        ...
        designer_ico = Qg.QIcon("./resources/icons/designer.ico")
        painter_ico = Qg.QIcon("./resources/icons/painter.ico")
        mari_ico = Qg.QIcon("./resources/icons/mari.ico")
        photoshop_ico = Qg.QIcon("./resources/icons/photoshop.ico")
    ...
    def render_comp_widget(self):
        ...
        guerilla_ico = Qg.QIcon("./resources/icons/guerilla.ico")
        nuke_ico = Qg.QIcon("./resources/icons/nuke.ico")
        resolve_ico = Qg.QIcon("./resources/icons/resolve.ico")
